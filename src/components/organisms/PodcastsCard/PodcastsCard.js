...
export function PodcastsCard({ Podcast }) {
  return (
        ...
        <div className={classes.mCtaRegion}>
          ...
          >
            ...
            >
              <path
                id="aLine"
                d="M69.5,66.7c-0.3,0.3-0.2,0.8,0.1,1.1c0.1,0.1,0.3,0.2,0.5,0.2c0.2,0,0.4-0.1,0.6-0.3c3.5-4.6,5.4-10,5.4-15.8
	...
	c-3.3-4.3-5-9.5-5-14.9c0-13.5,11-24.5,24.5-24.5c13.5,0,24.5,11,24.5,24.5C74.5,57.2,72.8,62.4,69.5,66.7z"
              />
              <path
                id="aLine_00000000938589367604435180000017051507034451254421_"
                d="M14.4,51.8c0-19.6,16-35.6,35.6-35.6s35.6,16,35.6,35.6
	...
	C20.3,74.9,14.4,63.8,14.4,51.8z"
              />
              <path
                id="aLine_00000144333056483666326940000009435564384680621462_"
                d="M50,3.5C23.4,3.5,1.8,25.2,1.8,51.8
	...
	c16.9-7.9,27.9-25.1,27.9-43.7C98.2,25.2,76.6,3.5,50,3.5z"
              ...
              <path
                id="aFill"
                d="M60.9,66.1H39.1c-2.8,0-5.1,2.3-5.1,5.1v25.2h32.1V71.2C66.1,68.4,63.8,66.1,60.9,66.1z"
              />
              <path
                id="aFill_00000095319161209598667280000009562044383411979951_"
                d="M50,64.6c7.1,0,12.8-5.8,12.8-12.8
